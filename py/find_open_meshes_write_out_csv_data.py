...
def main():
    ...
    walkdir = r"C:\Users\Scott\Desktop\Sim1_FBXs_171216"

    #CSV can't be used in rhino.python :(
    with open("C:\Users\Scott\Desktop\Sim1_dataout_171218_29.csv", "wb") as fout:
...
#                if int(roots.split('_')[-2]) <30:           # small subset control
