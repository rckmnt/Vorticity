...
workingDir = rs.BrowseForFolder("C:\\Users\\Scott\\Dropbox\\NBI\\Vorticity\\FBX_exports", "Pick a folder to save your files in")
...
for i in range(0,43,1):
    ...
    gh.RunSolver("C:\\Users\\Scott\\Dropbox\\NBI\\Vorticity\\ghx\\Vorticity_joinmesh_5")
