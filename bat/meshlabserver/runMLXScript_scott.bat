...
REM echo ------------------------------------------------------
REM echo    Do a simple mesh conversion on a folder
REM echo ------------------------------------------------------

rem Run the "for" loop from inside the input folder
rem cd %inputFolder%

rem echo for %%I in (*.%inputMeshFormat%) 

rem for %%I in (*.%inputMeshFormat%) do (%meshlabserverPath% -i %%I -o ..\%outputFolder%\%%~nI.%outputMeshFormat% %outputMeshOptions% -s %SCOTT_Script%)
rem To get help on the "for" syntax use: for /?
